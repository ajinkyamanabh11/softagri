...
class StockReportController extends GetxController {
  ...
  Future<void> refreshData() async {
    ...
    try {
      ...
      // Force refresh both item master and item detail using updated service
  ...
  Future<void> loadStockReport({bool forceRefresh = false}) async {
    ...
    try {
      ...
      // Use the updated HTTP service with pagination support
      ...
      // Try to load from cache using updated service
      try {
